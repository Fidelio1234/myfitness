...
const styles = {
  ...
  labelSezione: { color: "#1a5276", fontWeight: "700", fontSize: "1rem", margin: 0 },
  input: { padding: "0.8rem", borderRadius: "8px", border: "1px solid #85c1e9", background: "#fff", color: "#1a1a2e", fontSize: "0.95rem" },
  textarea: { padding: "0.8rem", borderRadius: "8px", border: "1px solid #85c1e9", background: "#fff", color: "#1a1a2e", fontSize: "0.95rem", minHeight: "80px", resize: "vertical" },
  eta: { color: "#1a5276", fontSize: "0.85rem", fontWeight: "700" },
  separator: { borderTop: "1px solid #b3d9f5", margin: "0.5rem 0" },
  ...
  card: { background: "#f5f5f5", borderRadius: "10px", padding: "1.2rem 1.5rem", display: "flex", justifyContent: "space-between", alignItems: "center", border: "1px solid #e0e0e0", gap: "1rem" },
  cardNome: { color: "#1a1a1a", fontWeight: "700", fontSize: "1.1rem", margin: "0 0 0.3rem 0" },
  cardInfo: { color: "#555", fontSize: "0.85rem", margin: "0.1rem 0" },
  cardProblemi: { color: "#e07b39", fontSize: "0.85rem", margin: "0.3rem 0 0 0" },
  ...
  cardPassword: { color: "#c0622a", fontSize: "0.82rem", fontWeight: "600", marginTop: "0.2rem", letterSpacing: "1px" },
};