...
export default function StoricoCliente({ clienteId }) {
  ...
  return (
    <div>
      <p style={styles.titoloSezione}>📅 Storico allenamenti</p>
      {[...log].reverse().map((sessione, i) => (
        <div key={i} style={styles.sessioneCard}>
          ...
          {sessione.pesoCorporeo && (
            <p style={styles.pesoCorporeo}>⚖️ Peso: {sessione.pesoCorporeo} kg</p>
          )}
...
const styles = {
  ...
  sessioneCard: { background: "#fff", borderRadius: "12px", padding: "1rem", marginBottom: "1rem", border: "1px solid #eee", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" },
  ...
  pesoCorporeo: { color: "#666", fontSize: "0.82rem", marginBottom: "0.5rem" },
  ...
  graficoBox: { background: "#fff", borderRadius: "12px", padding: "1.2rem", marginTop: "1rem", border: "1px solid #eee", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" },
